...
import { FaAngleDoubleRight, FaPlus, FaMinus } from 'react-icons/fa'
...
MangaHeader.propTypes = {
  manga: PropTypes.exact({
    name: PropTypes.node,
    data: PropTypes.array,
  }),
  zoomValue: PropTypes.node,
  brightVal: PropTypes.node,
  setBright: PropTypes.func,
